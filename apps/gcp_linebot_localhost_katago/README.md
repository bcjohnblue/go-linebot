...
3. **LOCALHOST_REVIEW_URL** - 本地 KataGo 服務的公開 URL

   ```bash
   # 如果使用 cloudflare tunnel 或 ngrok
   export LOCALHOST_REVIEW_URL=https://your-tunnel-url.com/review
   ```

4. **CLOUD_RUN_CALLBACK_REVIEW_URL** - Cloud Run 服務的回調 URL
   ```bash
   # 部署後會自動取得，格式為：
