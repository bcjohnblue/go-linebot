...
MODAL_FUNCTION_EVALUATION=${MODAL_FUNCTION_EVALUATION:-"evaluation"}
MODAL_FUNCTION_GET_AI_NEXT_MOVE=${MODAL_FUNCTION_GET_AI_NEXT_MOVE:-"get_ai_next_move"}
KATAGO_VISITS=${KATAGO_VISITS:-"1000"}
...
# 準備 Secrets Manager
SECRETS_ARG="--update-secrets=LINE_CHANNEL_ACCESS_TOKEN=LINE_CHANNEL_ACCESS_TOKEN:latest,OPENAI_API_KEY=OPENAI_API_KEY:latest,MODAL_TOKEN_ID=MODAL_TOKEN_ID:latest,MODAL_TOKEN_SECRET=MODAL_TOKEN_SECRET:latest,AUTH_TOKEN=AUTH_TOKEN:latest"

# 準備 Cloud Run 環境變數
# 包含應用啟動所需的所有環境變數
ENV_VARS_ARG="--set-env-vars=LOCALHOST_REVIEW_URL=${LOCALHOST_REVIEW_URL},CLOUD_RUN_CALLBACK_REVIEW_URL=${CLOUD_RUN_CALLBACK_REVIEW_URL},CLOUD_RUN_CALLBACK_GET_AI_NEXT_MOVE_URL=${CLOUD_RUN_CALLBACK_GET_AI_NEXT_MOVE_URL},GCP_PROJECT_ID=${PROJECT_ID},GCS_BUCKET_NAME=${GCS_BUCKET_NAME},MODAL_APP_NAME=${MODAL_APP_NAME},MODAL_FUNCTION_REVIEW=${MODAL_FUNCTION_REVIEW},MODAL_FUNCTION_EVALUATION=${MODAL_FUNCTION_EVALUATION},MODAL_FUNCTION_GET_AI_NEXT_MOVE=${MODAL_FUNCTION_GET_AI_NEXT_MOVE},KATAGO_VISITS=${KATAGO_VISITS}"
