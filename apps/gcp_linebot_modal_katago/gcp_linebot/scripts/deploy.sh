...
# 準備 Cloud Run 環境變數
# 包含應用啟動所需的所有環境變數
ENV_VARS_ARG="--set-env-vars=LOCALHOST_REVIEW_URL=${LOCALHOST_REVIEW_URL},CLOUD_RUN_CALLBACK_REVIEW_URL=${CLOUD_RUN_CALLBACK_REVIEW_URL},GCP_PROJECT_ID=${PROJECT_ID},GCS_BUCKET_NAME=${GCS_BUCKET_NAME},MODAL_APP_NAME=${MODAL_APP_NAME},MODAL_FUNCTION_REVIEW=${MODAL_FUNCTION_REVIEW}"
